...
const ResetPassword = () => {
    ...
    useEffect(() => {
        ...
        if (isAuthenticated) {
            toast.success("Welcome Back ! Your Password has been changed successfully.");
            navigate("/")
        }
        ...
        <div className='p-4 pb-8 flex flex-col xl:flex-row gap-4 w-full h-screen overflow-hidden'>
            <div className='lg:w-full xl:w-[40%] bg-[#f4f4f6] rounded-md py-8 px-6 flex flex-col gap-8 font-mono order-last xl:-order-last my-auto md:my-0'>
                ...
                <div className='flex flex-col gap-4 mx-auto'>
                    <h1 className='text-xl md:text-3xl font-semibold font-mono mx-auto'>Reset Your Password</h1>
                    ...
                    >
                        {loading ? (
                            <span className='flex gap-4 items-center justify-center'>
                                <CgSpinnerAlt size={28} className='animate-spin' /> Resetting...
                            </span>
                        ) : (
                            'Reset Password'
                        )}
        ...
        >
            ...
            <div className='flex flex-col gap-36 ml-8 text-white my-auto'>
                <div className='flex flex-col gap-4 w-[80%] select-none'>
                    <GiPadlock size={48} className='mr-2' />
                    <h1 className='text-4xl font-extrabold flex items-center ml-8'>
                        Secure Your Account
                    </h1>
                    <p className='text-base ml-8'>
                        Set a strong, new password to protect your account and continue enjoying our services.
                    </p>
                    <GiPadlock size={48} className='ml-auto' />
                </div>
            </div>
        </div>
    );
